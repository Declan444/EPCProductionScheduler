...
def get_sales_figures():
    ...
    while True:
        ...
        print('Sales figures should be entered as 5 numbers,'
              ' separated by commas.\n')
...
def get_lineOutput_figures():
    ...
    while True:
        ...
        print('Line Output figures should be entered as 5 numbers,'
              'separated by commas.\n')
...
def get_manufactured_figures():
    ...
    while True:
        ...
        print('Manufactured Volume figures should be'
...
def update_sales_worksheet(data):
    ...
    if len(data) == 5 and all(isinstance(num, int) for num in data):
        ...
        print(f'{red}Invalid data format:'
...
def update_manufacturing_worksheet(data):
    ...
    if len(data) == 5 and all(isinstance(num, int) for num in data):
        ...
        print(f'{green}Manufactured Volume worksheet'
               'updated successfully{white}\n')
    else:
        print(f'{red}Invalid data format:'
